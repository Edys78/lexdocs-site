    ...
    <aside className="fixed bottom-6 right-6 z-40">
      ...
      >
        <div className="relative flex items-center justify-center">
          <span className="material-symbols-outlined text-[22px] text-[#eec14b]">
            chat
          </span>
          <span className="absolute -top-1 -right-1 w-2.5 h-2.5 bg-emerald-500 rounded-full ring-2 ring-[#0d1c32] animate-pulse"></span>
        </div>
